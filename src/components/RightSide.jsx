  ...
  return (
    <div className='sm:w-1/2 flex justify-center'>
        <div className='flex w-[90%] sm:w-[75%] lg:w-[70%] flex-col gap-y-5'>
            ...
            <p className='max-w-68 text-sm my-2 lg:my-4 font-medium text-slate-500'>By creating an account you agree to our <span className='text-slate-800 underline'>Terms of use</span> and <span className='text-slate-800 underline'>privacy Policy</span></p>
